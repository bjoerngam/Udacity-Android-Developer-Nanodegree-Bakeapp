...
/**
 * This test will check if the user can click a single
 * recipe and after this if the ingredients and the steps are
 * visible.
 */

@RunWith(AndroidJUnit4.class)
public class SingleRecipeStep {

    @Rule
    public ActivityTestRule<MainActivity> mActivityTestRule = new ActivityTestRule<>(MainActivity.class);

    @Test
    public void singleRecipeStep() {
